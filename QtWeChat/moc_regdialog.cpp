...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_RegDialog_t, stringdata) + ofs \
...
QT_MOC_LITERAL(2, 31, 0)
    ...
    "RegDialog\0on_regButton_clicked\0"
};
...
const QMetaObject RegDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_RegDialog.data,
      qt_meta_data_RegDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_RegDialog.stringdata))
